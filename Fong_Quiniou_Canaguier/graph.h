...
class VertexInterface
{
    ...
    private :
        ...
        grman::WidgetButton m_supp_box;

        grman::WidgetImage m_supp_image;

        grman::WidgetBox m_connex_box;
...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetImage m_main_image;
        ...
        grman::WidgetImage m_connexite_image;

        grman::WidgetImage m_quitter_image;
...
class Graph
{
    ...
    public:
        ...
        void add_interfaced_vertex(int idx, double value, int x, int y,int maximum, std::string pic_name="",int pic_idx=0);
        void add_interfaced_edge(int idx, int vert1, int vert2, double weight=0);
        void test_remove_edge(int eidx);
        void test_remove_vertex(int eidx, Graphe first);
        /// Méthode spéciale qui construit un graphe arbitraire (démo)
        /// Voir implémentation dans le .cpp
        /// Cette méthode est à enlever et remplacer par un système
        /// de chargement de fichiers par exemple.
        void make_example();
        void make_graph(Graphe first);


        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
        Graphe update(Graphe first,int clk,bool &q, bool &r,std :: string fond,std :: string doct);
};
